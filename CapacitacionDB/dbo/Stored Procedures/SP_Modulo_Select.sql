...
-- Description:	Recupera Lista de modulos
-- =============================================
CREATE PROCEDURE [dbo].[SP_Modulo_Select]
...
BEGIN
	BEGIN TRY
		...
		SET @Codigo_Salida =1
		SET @Mensaje_Salida ='Se recupera lista los modulos exitosamente'
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[SP_Modulo_Select] TO [cap]
    AS [dbo];
